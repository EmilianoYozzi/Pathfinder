...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablero = new pathfinder.interfaz.Tablero();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Path Finder by Emiliano Yozzi");
    ...
    private void btnBuscarCaminoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCaminoActionPerformed
        pathFinder.generateMap(tablero.generateCode());
        tablero.borrarCamino();
        tablero.setCamino(pathFinder.findPath());
    ...
    private pathfinder.interfaz.Tablero tablero;
